...
export const fetchEquipo = async (): Promise<Equipo[]> => {
  try {
...
export const aboutUs = {
  ...
  liderTeam: {
    ...
    //     description:
    //       "Visionario líder en salud digital con enfoque estratégico y pasión por la innovación tecnológica.",
    //   },
    //   {
    //     name: "Jorge Martínez",
    ...
    //     description:
    //       "Estratega empresarial con experiencia en dirección organizacional y gestión de equipos de alto impacto.",
    //   },
    //   {
    //     name: "Carlos Mora",
    ...
    //     description:
    //       "Apasionado por el desarrollo de soluciones eficientes, guía técnica con enfoque colaborativo.",
    //   },
    //   {
    //     name: "Duiristt Coba",
    //     title: "Líder de desarrollo",
    ...
    //     description:
    //       "Líder técnico con una visión clara en innovación, enfocada en la mejora continua y mentoría de equipos.",
    //   },
    //   {
    //     name: "Jhan Ortegón",
    ...
    //     description:
    //       "Creativo y detallista en la experiencia de usuario, con fuerte dominio en tecnologías frontend modernas.",
    //   },
    //   {
    ...
    //     img: defaultImage,
    //     description:
    //       "Innovador y especializado en interfaces intuitivas y componentes reutilizables.",
    //   },
    //   {
    //     name: "Daniel leiva",
    //     title: "Desarrollador frontend",
    ...
    //     description:
    //       "Diseña interfaces que conectan, combinando elegancia visual con funcionalidad precisa y componentes modulares.",
    //   },
    //   {
    //     name: "Laura Navas",
    ...
    //     description:
    //       "Minuciosa en asegurar la calidad del producto, con enfoque en pruebas funcionales y experiencia del usuario.",
    //   },
    //   {
    //     name: "Michel Vázquez",
    //     title: "Analista de calidad",
    ...
    //     description:
    //       "Comprometido con la excelencia del software, experto en pruebas automatizadas y procesos QA.",
    //   },
    //   {
    //     name: "Mateo melendez",
    //     title: "Analista de calidad",
    //     img: defaultImage,
    //     description:
    //       "Analista de calidad enfocado en pruebas funcionales y mejora continua.",
    //   },
    //   {
    //     name: "Juan ricardo",
    //     title: "Analista de calidad",
    //     img: defaultImage,
    //     description:
    //       "Especialista en pruebas automatizadas y validación de entregables.",
    //   },
    //   {
    //     name: "Mario morales",
    ...
    //     description:
    //       "Desarrollador backend especializado en APIs robustas y seguras.",
    //   },
    //   {
    ...
    //     description:
    //       "Optimiza la lógica del servidor con código limpio y mantenible.",
    //   },
    //   {
    ...
    //     description:
    //       "Backend developer experto en automatización, integración y arquitectura limpia.",
    //   },
    //   {
    //     name: "Luis potte",
    //     title: "Desarrollador backend",
    //     img: defaultImage,
    //     description:
    //       "Crea y mantiene servicios backend eficientes con enfoque modular.",
    //   },
    //   {
    //     name: "Jhon santander",
    //     title: "Desarrollador backend",
    //     img: defaultImage,
    //     description:
    //       "Ingeniero backend enfocado en rendimiento, escalabilidad y bases de datos.",
    //   },
    //   {
    //     name: "Andres triana",
    //     title: "Implementador",
    ...
    //     description:
    //       "Implementador de soluciones tecnológicas, enfocado en puesta en marcha eficiente.",
    //   },
    //   {
    //     name: "Javier ramos",
    //     title: "Implementador",
    //     img: defaultImage,
    //     description:
    //       "Asegura el despliegue exitoso de sistemas con orientación al usuario final.",
    //   },
    // ],
  },
};
